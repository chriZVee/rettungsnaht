      ...
      <Page>
        <section className="imprint container">
          ...
          <div className="imprint-block imageSources">
            ...
            <p>
              Bildquellen: Startbild: [Fotografenname] auf Unsplash Krisengebiet
              1: [Fotografenname] auf Unsplash Krisengebiet 2: [Fotografenname]
              auf Unsplash … Quelle: https://unsplash.com
            </p>
          </div>
        </section>
      </Page>
