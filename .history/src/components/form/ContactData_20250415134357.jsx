  ...
  return (
    <div className="contact-data">
      ...
      <label className={`mobile-hidden ${isHandover ? "hidden" : ""} `}>
        ...
        />
        {locationError && !isEmpty(location) && (
          <p className="errorText">{locationErrorText}</p>
        )}
        {!locationError &&
          pickUpZipWarning(location) !== "" &&
          !isEmpty(location) && <p className="errorText">{pickUpZipWarning}</p>}
        {pickUpZipWarning(location) === "" && !isPickupZip(location) && (
