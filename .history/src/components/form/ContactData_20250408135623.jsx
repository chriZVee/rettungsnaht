...
export default function ContactData({
  ...
  const handleLocationChange = (e) => {
    ...
    if (isEmpty) {
      ...
      error = true;
      errorText =
        {`Abholung ist leider für deinen PLZ-Bereich nicht möglich (nur für ${officeZipFirstTwoDigits}xxx)`};
    } else {
      error = false;
      errorText = "";
    }
      ...
      <label className={`mobile-hidden ${isHandover ? "hidden" : ""} `}>
        ...
        {location === "" && (
          <p className="infoText">
            Abholung nur für Plz-Bereich {officeZipFirstTwoDigits} verfügbar.
          </p>
        )}
      </label>
    </div>
